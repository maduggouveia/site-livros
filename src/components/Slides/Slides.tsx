...
export function Destaques() {
    ...
    return (
        ...
        <div className={styles.emblaBox}>
            {/* botão anterior */}
            <button onClick={scrollPrev} className={styles['embla__button']}>❮</button>
            ...
            {/* botão próximo */}
            <button onClick={scrollNext} className={styles['embla__button']}>❯</button>
        </div>
