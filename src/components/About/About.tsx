...
export function About() {
    ...
    return (
        ...
        <div className={styles.sobreMim}>
            ...
            <ExportedImage src="/imgs/fotoautora.png" alt="foto da autora" width={200} height={200} className={styles.imgPerfil} />
          ...
          <div className={styles.sobreParteEscrita}>
            ...
            <ul className={styles.redesSociais}>
                <li><a href="https://www.amazon.com.br/stores/Madu-Gon%C3%A7alves/author/B08R951KTT" target="_blank" className={styles.linkRedes}><ExportedImage src="/imgs/amazon-preto.svg" width={30} height={30} alt="amazon" /></a></li>

                <li><a href="https://www.instagram.com/madueoslivros" target="_blank" className={styles.linkRedes}><ExportedImage src="/imgs/igpreto.svg" width={30} height={30} alt="instagram" /></a></li>
                ...
                <li><a href="mailto:madueoslivros@gmail.com" target="_blank" className={styles.linkRedes}><ExportedImage src="/imgs/emailpreto.svg" width={30} height={30} alt="e-mail" /></a></li>
